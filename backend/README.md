...
## Project Structure
    ...
    ├── creepsi_twisted_tal_30998  # Django project configurations
...
1. Clone this repo and `cd creepsi_twisted_tal_30998`
...
2. Clone this repo and `cd creepsi_twisted_tal_30998`
